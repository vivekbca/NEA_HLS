...
@Injectable()
@Component({
  selector: 'app-dashboardviewonly',
  templateUrl: './dashboardviewonly.component.html',
  styleUrls: ['./dashboardviewonly.component.css']
})
export class DashboardviewonlyComponent implements OnInit {
  cam1:any
  showUser = false
   ...
   this.tilescount=4;
    ...
    setTimeout( ()=>{
     ...
     if(4<=this.camlength)
     {
      ...
      // if(1<=this.camlength && this.tilescount==4)
      // {
      //   var key1=Object.values(this.camList[0])[0]
      //   new callhls1(key1) //#HLS
      // }
      ...
      //   new callhls4(key4) //#HLS
      // } 
      // if(5<=this.camlength && this.tilescount==4)
      // {
      //   var key5=Object.values(this.camList[4])[0]
      //   new callhls5(key5) //#HLS
      // }
      //  if(6<=this.camlength && this.tilescount==8)
      // {
...
// new playClick();
//   }
  // getCamURL(buffer:any){
  //   this.substring = buffer.substring(31,39)
  //   //https://nea.echoltech.com/auth/cck_cam1/cgi-bin/mjpg/video.cgi?channel=1&subtype=1
  ...
  changeCam(camip:any,camname:any,cameraname:any){
    ...
    // new playClick(cameraip);
    // const JSMpeg = require('jsmpeg-player');
    //         this.player = new JSMpeg.Player(camip, {
    //         canvas: document.getElementById('canvas'), autoplay: true, audio: false
  ...
  // changeCam(camip:any,camname:any){
  //   //this.zoomout();
  //   console.log('cam ip --> ',camip)
  //   this.cam1 = camip
  //   this.camname = camname
  //   this.getCamURL(this.cam1)
  // }
